import FuseExample from '@fuse/core/FuseExample';
                ...
                <>
					<div className="flex flex-1 sm:flex-row flex-col items-start justify-center grow-0 md:items-center md:justify-end md:space-between">
                     ...
                     <Typography className="text-32 my-16 font-700" component="h1">Grid</Typography>
...
<Typography className="text-14 mb-32" component="div">The <a href="https://m2.material.io/design/layout/responsive-layout-grid.html">grid</a> creates visual consistency between layouts while allowing flexibility across a wide variety of designs.
...
<Typography className="text-14 mb-32" component="div">If you are <strong>new to or unfamiliar with flexbox</strong>, we encourage you to read this <a href="https://css-tricks.com/snippets/css/a-guide-to-flexbox/">CSS-Tricks flexbox</a> guide.</Typography>
...
<Typography className="text-14 mb-32" component="div">For example, <code>{`xs={12} sm={6}`}</code> sizes a component to occupy half of the viewport width (6 columns) when viewport width is <a href="/material-ui/customization/breakpoints/#default-breakpoints">600 or more pixels</a>. For smaller viewports, the component fills all 12 available columns.</Typography>
<Typography className="text-14 mb-32" component="div"><FuseExample
...
<Typography className="text-14 mb-32" component="div">A flex <strong>container</strong> is the box generated by an element with a computed display of <code>{`flex`}</code> or <code>{`inline-flex`}</code>. In-flow children of a flex container are called flex <strong>items</strong> and are laid out using the flex layout model.</Typography>
</div>

<Typography className="text-14 mb-32" component="div"><a href="https://www.w3.org/TR/css-flexbox-1/#box-model">https://www.w3.org/TR/css-flexbox-1/#box-model</a></Typography>
<Typography className="text-14 mb-32" component="div"><FuseExample
                    name="NestedGrid.js"
                    className="my-16"
                    iframe={false}
...
<Typography className="text-14 mb-32" component="div">If you need to do such, remove one of the props.</Typography>
<Typography className="text-24 mt-24 mb-10 font-700" component="h2">Columns</Typography>
<Typography className="text-14 mb-32" component="div">You can change the default number of columns (12) with the <code>{`columns`}</code> prop.</Typography>
<Typography className="text-14 mb-32" component="div"><FuseExample
                    name="ColumnsGrid.js"
                    className="my-16"
                    iframe={false}
...
<Typography className="text-14 mb-32" component="div">The spacing between items is implemented with a negative margin. This might lead to unexpected behaviors. For instance, to apply a background color, you need to apply <code>{`display: flex;`}</code> to the parent.</Typography>
...
<Typography className="text-14 mb-32" component="div">In order for the item to stay within the container you need to set <code>{`min-width: 0`}</code>.
...
<Typography className="text-14 mb-32" component="div">They define the number of grids the component will use for a given breakpoint. They are intended to control <strong>width</strong> using <code>{`flex-basis`}</code> in <code>{`row`}</code> containers but they will impact height in <code>{`column`}</code> containers.
If used, these props may have undesirable effects on the height of the <code>{`Grid`}</code> item elements.</Typography>
<Typography className="text-24 mt-24 mb-10 font-700" component="h2">CSS Grid Layout</Typography>
<Typography className="text-14 mb-32" component="div">The <code>{`Grid`}</code> component is using CSS flexbox internally.
But as seen below, you can easily use <a href="/system/grid/">the system</a> and CSS Grid to layout your pages.</Typography>
<Typography className="text-14 mb-32" component="div"><FuseExample
                    name="CSSGrid.js"
                    className="my-16"
                    iframe={false}
...
For instance, a padding:</Typography>
