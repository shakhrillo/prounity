...
const Care: React.FC = () => {
  const [user, setUser] = useState<User>({ username: '', first_name: '' });
  ...
  const getCare = async () => {
    try {
      const response = await fetch(
        'https://prounity.uz/plants/api/app/plant-care-trees/'
      );
                ...
                >
                  ...
                  >
                    <img
                      ...
                      src={`https://prounity.uz${item.img}`}
                      alt=''
                    />
                  </div>
                  <div
