...
class Conversation(models.Model):
  initiator = models.ForeignKey(CustumUsers, on_delete=models.CASCADE, null=True, related_name='convo_starter')
  receiver = models.ForeignKey(CustumUsers, on_delete=models.CASCADE, null=True, related_name='convo_participant')
  start_time = models.DateTimeField(auto_now_add=True, verbose_name='Time stamp')


class Message(models.Model):
  sender = models.ForeignKey(CustumUsers, on_delete=models.CASCADE, null=True, related_name='message_sender')
